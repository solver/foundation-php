...
class TemplateCompiler implements PsrxCompiler {
	...
	/**
	 * @param string $class
	 * Default = "\Solver\Web\Template". Target class for compilation. This affects which function calls are 
	...
	public function compileFromString($source, $sourcePathname, $symbolName) {
		...
		// TODO: Verify here $this->class is instanceof \Solver\Web\Template (we accept only this and subclasses of it).
